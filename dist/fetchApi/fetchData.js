...
exports.listDataFetch = exports.numbersArray = exports.dataFetch = void 0;
exports.dataFetch = {
...
const listDataFetch = [];
exports.listDataFetch = listDataFetch;
...
for (let i = 0; i < 10; i++) {
    exports.dataFetch.imsi = exports.numbersArray[1];
    exports.dataFetch.current_quota = Math.floor(Math.random() * 10) + 1;
    exports.dataFetch.current_quota_SMS = Math.floor(Math.random() * 10) + 1;
    listDataFetch.push(exports.dataFetch);
}
